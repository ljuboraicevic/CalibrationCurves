...
public class LinearRegressionTest {
    ...
    public void testCompute() {
        ...
        double[]   t1 = LinearRegression.compute(x1, y1).getRowPackedCopy();
        ...
        double[]   t2 = LinearRegression.compute(x2, y2).getRowPackedCopy();
        ...
        double[]   t3 = LinearRegression.compute(x3, y3).getRowPackedCopy();
        ...
        double[]   t4 = LinearRegression.compute(x4, y4).getRowPackedCopy();
        ...
        double[]   t5 = LinearRegression.compute(x5, y5).getRowPackedCopy();
        ...
        double[]   t6 = LinearRegression.compute(x6, y6).getRowPackedCopy();
    ...
    public void testDotProduct() {
        try {
            ...
            assertEquals(r1.getArray()[0][0], result1.getArray()[0][0], 0.0001);
            assertEquals(r1.getArray()[0][1], result1.getArray()[0][1], 0.0001);
            
            Matrix a2 = new Matrix(new double[][]{{1, 5}, {4, 20}});
            Matrix b2 = new Matrix(new double[][]{{6, 3}, {3,  0}});
            Matrix r2 = new Matrix(new double[][]{{6, 15}, {12, 0}});
            Matrix result2 = (Matrix)method.invoke(Matrix.class, a2, b2);
            assertEquals(r2.getArray()[0][0], result2.getArray()[0][0], 0.0001);
            assertEquals(r2.getArray()[0][1], result2.getArray()[0][1], 0.0001);
